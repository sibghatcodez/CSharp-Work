...
namespace C__Day52
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            Profile pfp = new Profile(nameBtn.Text, int.Parse(ageBtn.Text), maleRadio.Text == "Male" ? "Male" : "Female");
            Stream file = new FileStream("E:profile.txt", FileMode.OpenOrCreate, FileAccess.Write);
            using (StreamWriter writeFile = new StreamWriter(file))
            {
                writeFile.WriteLine("E:profile.txt", pfp);
            }
        }
    }

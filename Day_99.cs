        ...
        private void UpdatePlayerTurnText(bool player)
        {
            ...
            if(boxesSelected >= 5)
            {
                ...
                Debug.WriteLine("\n ------------------------ \n");
                    ...
                    Debug.Write("[ ");
                foreach(var firstRow in box1_3)
                {
                    Debug.Write(firstRow + " ");
                }
                    Debug.Write(" ] ");
                ...
                Debug.Write("[ ");
                foreach (var secondRow in box3_6)
                {
                    Debug.Write(secondRow + " ");
                }
                Debug.Write(" ] ");
                ...
                Debug.Write("[ ");
                foreach (var thirdRow in box1_3)
                {
                    Debug.Write(thirdRow + " ");
                }
                Debug.Write(" ] ");
            }
        }
